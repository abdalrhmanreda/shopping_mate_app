...
class ProductScreen extends StatelessWidget {
    ...
    return BlocConsumer<ShopMateCubit, ShopMateStates>(
      ...
      builder: (context, state) {
        return ConditionalBuilder(
          ...
          condition: ShopMateCubit
              .get(context)
              .homeModel != null,
          builder: (context) =>
              productsBuilder(ShopMateCubit
                  .get(context)
                  .homeModel!, context),
          fallback: (context) =>
          const Center(
        ...
        child: Container(
          ...
          child: Column(
            children: [
              CarouselSlider(
                items: images
                    .map((e) => Image.asset(e ,   width: double.infinity, fit: BoxFit.cover)).toList(),
  ...
  Widget GridItem(ProductInfo product, context) =>
      InkWell(
        onTap: () {
          dynamic prcentage = ((product.old_price-product.price)/product.old_price)*100 ;

          NavigatTo(context, ProductDetails(
            id: product.id!,
              name: product.name!,
                ...
                Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: const Text('Discount', textAlign: TextAlign.center,
                        style: TextStyle(color: Colors.white, fontSize: 11),),

                    ),
                  ],
                ),
              CachedNetworkImage(imageUrl: product.image! ,width: double.infinity, height: 200 ),
