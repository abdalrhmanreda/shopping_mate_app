          ...
          return ConditionalBuilder(
            ...
            builder: (context) => Scaffold(
              ...
              body: ListView.separated(
                ...
                itemCount: ShopMateCubit.get(context)
                    .favoriteModel!
                    .data!
                    .productsList
                    .length,
            ...
            fallback: (context) => Center(
              child: Lottie.network(
                'https://assets1.lottiefiles.com/packages/lf20_ycdtcb3u.json',
              ),
            ),
          );
        });
  ...
  Widget Item(Data productDataModel, context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Image.network(
            '${productDataModel.product!.image}',
            height: 150,
            width: 150,
          ),
          Expanded(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Text('${productDataModel.product!.price} EGP',
                      ...
                      if (productDataModel.product!.discount != 0)
                        Text('${productDataModel.product!.old_price} EGP',
                            style: const TextStyle(
                                fontSize: 12,
                                color: Colors.grey,
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          ShopMateCubit.get(context)
                              .changeFavorite(productDataModel.product!.id!);
                        },
                        icon: ShopMateCubit.get(context)
                                .favoriteMap[productDataModel.product!.id]!
                            ? const Icon(
                                HeroIcons.heart,
                                size: 24,
                                color: Colors.red,
